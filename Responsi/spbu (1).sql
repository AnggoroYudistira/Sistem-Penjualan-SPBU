...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2018 at 02:27 PM
...
INSERT INTO `transaksi` (`Id_JenisBBM`, `Pembelian_ke`, `Jenis_BBM`, `Harga`, `Liter`, `Beli`) VALUES
(1, '1', 'Pertalite', '8500', '1,18', '10000'),
(2, '1', 'Pertamax', '9000', '1', '9000'),
(3, '1', 'Pertalite', '8500', '1,18', '10000');
...
--
ALTER TABLE `transaksi`
  MODIFY `Id_JenisBBM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
